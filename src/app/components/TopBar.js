...
export default function TopBar() {
  return (
    <div className="fixed hidden md:grid bg-slate-900 grid-cols-2 z-20 h-16 w-full">
      ...
      <div className="flex pl-2">
        <div className="flex px-6 items-center space-x-2">
          ...
          <Link
            href="tel:+923458222263"
            aria-label="Call The Asthetik Clinic at +92 345 822 2263"
            className="text-white text-sm focus:outline-none focus:ring-2 focus:ring-white/60 rounded"
          >
            +92-345-8222263
          </Link>
        </div>
        ...
        <div className="flex px-6 mx-auto items-center space-x-2">
          ...
          <Link
            href="mailto:info@theasthetik.com"
            aria-label="Email The Asthetik Clinic at info@theasthetik.com"
            className="text-white text-sm focus:outline-none focus:ring-2 focus:ring-white/60 rounded"
          >
    ...
    <ul className="flex space-x-3" aria-label="Social media links">
  <li>
    <Link
